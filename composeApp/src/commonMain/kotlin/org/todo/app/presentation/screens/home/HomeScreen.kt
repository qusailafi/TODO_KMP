...
import org.todo.app.presentation.screens.tasks_screen.TaskScreen
...
import org.todo.app.component.ErrorScreen
import org.todo.app.component.LoadingScreen
import org.todo.app.component.TaskView
...
fun DisplayTasks(
    ...
    tasks: RequestState<List<TodTask>>,
    showActive: Boolean = true,
    onSelect: ((TodTask) -> Unit)? = null,
    onFavorite: ((TodTask, Boolean) -> Unit)? = null,
    onComplete: (TodTask, Boolean) -> Unit,
    onDelete: ((TodTask) -> Unit)? = null
) {
    var showDialog by remember { mutableStateOf(false) }
    var taskToDelete: TodTask? by remember { mutableStateOf(null) }
