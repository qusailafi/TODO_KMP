...
@NonNullApi
public class TodAppProjectDependency extends DelegatingProjectDependency {

    @Inject
    public TodAppProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
